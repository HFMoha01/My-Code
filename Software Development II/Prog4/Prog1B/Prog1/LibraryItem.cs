...
namespace LibraryItems
{
    public abstract class LibraryItem :IComparable<LibraryItem>
    {
        ...
        // Precondition: none
        //Postcondition: Returns Library item sorted by title
        //                 When this < t2, method returns negative #
        ...
        public int  CompareTo( LibraryItem item2)
        {
            ...
            if (item2 == null)  // item2 a null ?
                return 1;  //indicate a response greater than

            else 
                return this.Title.CompareTo(item2.Title); // ascending order of the item by title
