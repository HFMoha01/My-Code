...
-- You need to replace ## with your two-digit SQL Server ID in the VM.
IF EXISTS(select * from sys.databases where name='Oldhouse_##')
DROP DATABASE Oldhouse_##
GO

CREATE DATABASE Oldhouse_##
Go
USE Oldhouse_##
GO
